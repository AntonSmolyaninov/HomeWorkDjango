...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        cat1 = Category.objects.create(name_category='Рассылки', description_category='Сервисы для массовых рассылок')
        cat2 = Category.objects.create(name_category='Телеграм боты', description_category='Боты для Telegram')
        cat3 = Category.objects.create(name_category='Веб-приложения', description_category='Готовые веб-приложения')
